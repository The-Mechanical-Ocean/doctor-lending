  ...
  return (
    <section className="about" id='about'>
      <div className='about__info-container'>
        ...
        <a className='about__href' href={ `https://wa.me/${PHONE_NUMBER}?text=${encodeURIComponent(MESSAGE)}` } target='_blank'
           onClick={ () => { setIsClick(!isClick) }}>
          { isClick ? <p className='about__href-text'>Уже записались?</p> : <p className='about__href-text'>Записаться на консультацию</p> }
        </a>
      </div>   
