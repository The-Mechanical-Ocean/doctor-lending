  ...
  return (  
    <section className='inovation' id='inovation'>
      ...
      <div className='inovation__container-s'>
        <p className='inovation__text-s'>Специально разработанные водные программы для людей имеющих проблемы со здоровьем </p>
      </div>
      <div className='inovation__container-s'>
        <p className='inovation__text-s'>Саунатерапия, как способ лечения и востановления человечесеского органзма от болезней</p>  
      </div>
      <div className='inovation__container-s'>
        <p className='inovation__text-s'>Лучшее оборудование- спортивные и реабилитационные тренажеры(кинезиотерапия, ранее известная, как механотерпия)</p>
      </div>  
