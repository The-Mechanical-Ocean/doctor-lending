  ...
  return (
    <footer className="footer">
      ...
      <p className="footer__text">
        Центр Доктора Лабунца - все права защищены 2022
      </p>
      <div className="footer__contact-container">
        ...
        <div className="footer__contact-container-small">
          ...
          <a
            ...
            target="_blank"
          >
            <p className="footer__contact-container-small-text">89160978804</p>
          </a>
        </div>
        <div className="footer__contact-container-small">
        ...
        <div className="footer__contact-container-small">
          <h3 className="footer__contact-container-small-title">
            Социальные сети
          </h3>
          <div className="footer__img-container">
            ...
            <a href="" className="footer__link">
              <div className="footer__twit-img"></div>
            </a>
          </div>
        </div>
      </div>
      <iframe
        ...
        src="https://yandex.ru/map-widget/v1/?um=constructor%3A319acaa98e815b7222a78f733279b72ebb5b65e621800c0f978fbf5230e850b7&amp;source=constructor"
        width="632"
        height="497"
        frameBorder="0"
      ></iframe>
